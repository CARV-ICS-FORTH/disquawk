...
public class PowerMeter {
    ...
    public PowerMeter(String host, int port) {
        ...
        try {
			...
			if (meterResponseParts.length == 12) 
			{
				...
				if (verbose) 
				{
					System.out.println("Power analyzer type: " + meterResponseParts[0]);
					System.out.println("Power analyzer SPEC compliant: " + meterResponseParts[8]);
			...
			{ // error in meter response
				System.out.println("Warning! Unexpected input from power meter: " + meterResponse);
	...
	{	
		...
		{ // error in meter response
			System.out.println("Warning! Unexpected input from power meter: " + msg);
