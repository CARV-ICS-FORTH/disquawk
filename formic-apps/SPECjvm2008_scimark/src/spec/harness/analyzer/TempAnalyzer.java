...
public class TempAnalyzer extends AnalyzerBase {
    ...
    public static void setupAnalyzerClass() {
        ...
        if (verbose) {
            System.out.println("Connecting to temp sensor " + tempSensorHost + ":" + tempSensorPort);
        }

        if (!dummy) {
            tempSensor = new TempSensor(tempSensorHost, tempSensorPort);
            if (verbose) {
                System.out.println("Temperature sensor type is " + tempSensor.sensorType());
                System.out.println("Temperature sensor ptd version is " + tempSensor.sensorPtdVersion());
                System.out.println("Temperature sensor ptd host OS is " + tempSensor.sensorPtdHostOs());
            }
    ...
    public static void tearDownAnalyzerClass() {
        if (verbose) {
            System.out.println("Tearing down temperature sensor class.");
        }
        if (dummy) {
            return;
        }
    ...
    public void startMeasurementInterval() {
        ...
        if (verbose) {
            System.out.println("Starting temp measurement interval.");
        }
        if (dummy) {
            return;
        }
    ...
    public void endMeasurementInterval() {
        ...
        if (verbose) {
            System.out.println("Ending temperature measurement interval.");
        }
        if (dummy) {
            return;
        }
    ...
    public void tearDown() {
        ...
        if (verbose) {
            System.out.println("Tearing down TempAnalyzer.");
        }
        if (dummy) {
