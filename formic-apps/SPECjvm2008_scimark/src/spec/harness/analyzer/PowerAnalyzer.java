...
public class PowerAnalyzer extends AnalyzerBase {
    ...
    public static void setupAnalyzerClass() {
        ...
        if (verbose) {
            System.out.println("Connecting to power analyzer " + powerMeterHost + ":" + powerMeterPort);
        }
        ...
        if (verbose) {
            System.out.println("Power analyzer type is " + powerMeter.meterType());
            System.out.println("Power analyzer ptd version is " + powerMeter.meterPtdVersion());
            System.out.println("Power analyzer ptd host OS is " + powerMeter.meterPtdHostOs());
        }
    ...
    public static void tearDownAnalyzerClass() {
        if (verbose) {
            System.out.println("Tearing down power analyzer class.");
        }
        if (dummy) {
            return;
        }
    ...
    public void startMeasurementInterval() {
        ...
        if (verbose) {
            System.out.println("Starting power measurement interval.");
        }
        if (dummy) {
            return;
        }
    ...
    public void endMeasurementInterval() {
        ...
        if (verbose) {
            System.out.println("Ending power measurement interval.");
        }
        if (dummy) {
            return;
        }
    ...
    public void tearDown() {
        ...
        if (verbose) {
            System.out.println("Tearing down PowerAnalyzer.");
        }
        if (dummy) {
