...
public class RenderThread implements Runnable {
	...
	/**
	 * Konstruktor for einen RenderThread
	 *
	 * @param aPart
	...
	public void run(){
		...
		int w, h, k, i=0, j;
		//Die "tmp_x" double-Arrays werden der intersect2-Methode mitgegeben damit nicht for jeden Schnitt neue Variablen angelegt werden mussen:
