...
public class Camera {
	 ...
	 * @param aScreenHeight	Bildschirmhohe (Pixel)
...
//		cBuffer = new int[screenWidth][screenHeight][3];
	...
	/**
	 * Schreibt eine Screenpartition zuruck in die Kamera-Puffer
	 *
	 * @param aPart	Screenpartition die zuruckgeschrieben wird
	 */
	...
	/**
	 * Gibt die Pixelkoordinaten(x und y Werte der Pixel) fur einen Teil des Bildpuffers zuruck.
	 *
	 * @param aNumPartitions	Gibt an in wieviele Stucke der Bildpuffer zerlegt wird
	 * @param aOffset			Gibt an welches Stuck zuruckgegebenwird
