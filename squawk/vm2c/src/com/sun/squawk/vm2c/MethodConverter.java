...
public class MethodConverter extends JCTree.Visitor {
	...
	class Tuple {
		...
		Tuple(String literal, String className) {
	...
	public Map<Integer, Tuple> literals;
	...
	public MethodConverter(ProcessedMethod method, Converter conv, LineNumberTable lnt) {
		...
		this.literals = new HashMap<Integer, Tuple>();
	...
	public void visitLiteral(JCTree.JCLiteral tree) {
		...
		default:
			...
			literals.put(new Integer(key), new Tuple(literal, className));
