        ...
        implements Queue<E>// , java.io.Serializable
{
    ...
    private static class Node<E> {
        ...
        Node(E x) { item = new AtomicReference(x); }

        Node(E x, Node<E> n) {
            item = new AtomicReference(x);
     ...
     */
	private transient AtomicReference<Node<E>> head =
	    new AtomicReference(new Node<E>(null, null));

    /** Pointer to last node on list **/
	private transient AtomicReference<Node<E>> tail =
