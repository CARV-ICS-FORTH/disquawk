...
public abstract class AbstractQueuedSynchronizer
    ...
    static final class Node {
        ...
        Node(Thread thread, int waitStatus) { // Used by Condition
            this.waitStatus = new AtomicInteger(waitStatus);
            this.thread = thread;
        }
    }
     ...
     * CANCELLED.
     */
    private transient AtomicReference<Node> head;

    /**
     * Tail of the wait queue, lazily initialized.  Modified only via
     * method enq to add new wait node.
     */
    private transient AtomicReference<Node> tail;
            ...
            if (h != null && h != tail.get()) {
                ...
                if (ws == Node.SIGNAL) {
                    ...
                    unparkSuccessor(h);
                         ...
                         !h.waitStatus.compareAndSet(0, Node.PROPAGATE))
    ...
    //     return head.compareAndSwap(null, update);
    // }
    ...
    //     return tail.compareAndSwap(expect, update);
    // }
    ...
    //                                                      int expect,
    //                                                      int update) {
    //     return node.waitStatus.compareAndSwap(expect, update);
    // }
    ...
    //                                                Node expect,
    //                                                Node update) {
    //     return node.next.compareAndSwap(expect, update);
    // }
}
