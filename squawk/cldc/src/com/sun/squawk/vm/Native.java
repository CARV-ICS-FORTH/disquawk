...
public final class Native {
    ...
    public final static int com_sun_squawk_VM$doubleToLongBits            = 119;
    public final static int com_sun_squawk_VM$executeCIO                  = 120;
    public final static int com_sun_squawk_VM$executeCOG                  = 121;
    public final static int com_sun_squawk_VM$executeGC                   = 122;
    public final static int com_sun_squawk_VM$fatalVMError                = 123;
    public final static int com_sun_squawk_VM$finalize                    = 124;
    public final static int com_sun_squawk_VM$floatToIntBits              = 125;
    public final static int com_sun_squawk_VM$getBranchCount              = 126;
    public final static int com_sun_squawk_VM$getCore                     = 127;
    public final static int com_sun_squawk_VM$getFP                       = 128;
    public final static int com_sun_squawk_VM$getGlobalAddr               = 129;
    public final static int com_sun_squawk_VM$getGlobalInt                = 130;
    public final static int com_sun_squawk_VM$getGlobalOop                = 131;
    public final static int com_sun_squawk_VM$getGlobalOopCount           = 132;
    public final static int com_sun_squawk_VM$getGlobalOopTable           = 133;
    public final static int com_sun_squawk_VM$getIsland                   = 134;
    public final static int com_sun_squawk_VM$getMP                       = 135;
    public final static int com_sun_squawk_VM$getPreviousFP               = 136;
    public final static int com_sun_squawk_VM$getPreviousIP               = 137;
    public final static int com_sun_squawk_VM$hashcode                    = 138;
    public final static int com_sun_squawk_VM$initializeLiterals          = 139;
    public final static int com_sun_squawk_VM$intBitsToFloat              = 140;
    public final static int com_sun_squawk_VM$invalidateClassStateCache   = 141;
    public final static int com_sun_squawk_VM$isBigEndian                 = 142;
    public final static int com_sun_squawk_VM$longBitsToDouble            = 143;
    public final static int com_sun_squawk_VM$math                        = 144;
    public final static int com_sun_squawk_VM$serviceResult               = 145;
    public final static int com_sun_squawk_VM$setBytes                    = 146;
    public final static int com_sun_squawk_VM$setGlobalAddr               = 147;
    public final static int com_sun_squawk_VM$setGlobalInt                = 148;
    public final static int com_sun_squawk_VM$setGlobalOop                = 149;
    public final static int com_sun_squawk_VM$setPreviousFP               = 150;
    public final static int com_sun_squawk_VM$setPreviousIP               = 151;
    public final static int com_sun_squawk_VM$threadSwitch                = 152;
    public final static int com_sun_squawk_VM$zeroWords                   = 153;
    public final static int com_sun_squawk_CheneyCollector$memoryProtect  = 154;
    public final static int com_sun_squawk_ServiceOperation$cioExecute    = 155;
    public final static int com_sun_squawk_GarbageCollector$collectGarbageInC = 156;
    public final static int com_sun_squawk_GarbageCollector$hasNativeImplementation = 157;
    public final static int com_sun_squawk_Lisp2Bitmap$clearBitFor        = 158;
    public final static int com_sun_squawk_Lisp2Bitmap$clearBitsFor       = 159;
    public final static int com_sun_squawk_Lisp2Bitmap$getAddressForBitmapWord = 160;
    public final static int com_sun_squawk_Lisp2Bitmap$getAddressOfBitmapWordFor = 161;
    public final static int com_sun_squawk_Lisp2Bitmap$initialize         = 162;
    public final static int com_sun_squawk_Lisp2Bitmap$iterate            = 163;
    public final static int com_sun_squawk_Lisp2Bitmap$setBitFor          = 164;
    public final static int com_sun_squawk_Lisp2Bitmap$setBitsFor         = 165;
    public final static int com_sun_squawk_Lisp2Bitmap$testAndSetBitFor   = 166;
    public final static int com_sun_squawk_Lisp2Bitmap$testBitFor         = 167;
    public final static int com_sun_squawk_SoftwareCache$inHeap           = 168;
    ...
    public final static int com_sun_squawk_platform_MMGR$addWaiter        = 172;
    ...
    public final static int com_sun_squawk_platform_MMGR$notify           = 175;
