...
public final class Native {
    ...
    public final static int com_sun_squawk_VM$hasVirtualMonitorObject     = 139;
    public final static int com_sun_squawk_VM$hashcode                    = 140;
    public final static int com_sun_squawk_VM$initializeLiterals          = 141;
    public final static int com_sun_squawk_VM$intBitsToFloat              = 142;
    public final static int com_sun_squawk_VM$invalidateClassStateCache   = 143;
    public final static int com_sun_squawk_VM$isBigEndian                 = 144;
    public final static int com_sun_squawk_VM$longBitsToDouble            = 145;
    public final static int com_sun_squawk_VM$math                        = 146;
    public final static int com_sun_squawk_VM$removeVirtualMonitorObject  = 147;
    public final static int com_sun_squawk_VM$serviceResult               = 148;
    public final static int com_sun_squawk_VM$setBytes                    = 149;
    public final static int com_sun_squawk_VM$setGlobalAddr               = 150;
    public final static int com_sun_squawk_VM$setGlobalInt                = 151;
    public final static int com_sun_squawk_VM$setGlobalOop                = 152;
    public final static int com_sun_squawk_VM$setPreviousFP               = 153;
    public final static int com_sun_squawk_VM$setPreviousIP               = 154;
    public final static int com_sun_squawk_VM$threadSwitch                = 155;
    public final static int com_sun_squawk_VM$zeroWords                   = 156;
    public final static int com_sun_squawk_CheneyCollector$memoryProtect  = 157;
    public final static int com_sun_squawk_ServiceOperation$cioExecute    = 158;
    public final static int com_sun_squawk_GarbageCollector$collectGarbageInC = 159;
    public final static int com_sun_squawk_GarbageCollector$hasNativeImplementation = 160;
    public final static int com_sun_squawk_Lisp2Bitmap$clearBitFor        = 161;
    public final static int com_sun_squawk_Lisp2Bitmap$clearBitsFor       = 162;
    public final static int com_sun_squawk_Lisp2Bitmap$getAddressForBitmapWord = 163;
    public final static int com_sun_squawk_Lisp2Bitmap$getAddressOfBitmapWordFor = 164;
    public final static int com_sun_squawk_Lisp2Bitmap$initialize         = 165;
    public final static int com_sun_squawk_Lisp2Bitmap$iterate            = 166;
    public final static int com_sun_squawk_Lisp2Bitmap$setBitFor          = 167;
    public final static int com_sun_squawk_Lisp2Bitmap$setBitsFor         = 168;
    public final static int com_sun_squawk_Lisp2Bitmap$testAndSetBitFor   = 169;
    public final static int com_sun_squawk_Lisp2Bitmap$testBitFor         = 170;
    public final static int com_sun_squawk_SoftwareCache$translate        = 171;
    public final static int com_sun_squawk_platform_MMP$checkMailbox      = 172;
