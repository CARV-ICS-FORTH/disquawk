...
public interface HDR {
    ...
    /**
     * The amount by which to right shift a byte offset to find the
     * offset of the word that contains the indexed byte.
     */
    public final static int LOG2_BYTES_PER_WORD = (/*VAL*/false/*SQUAWK_64*/ ? 3 : 2);

    /**
     * The size (in bytes) of a cache-line pointer.
     */
    public final static int BYTES_PER_CACHE_LINE =
	    (/*VAL*/false/*SQUAWK_64*/ ? 128 : 64);

    /**
     * The amount by which to right shift a byte offset to find the
     * offset of the cache-line that contains the indexed byte.
     */
    public final static int LOG2_BYTES_PER_CACHE_LINE =
	    (/*VAL*/false/*SQUAWK_64*/ ? 7 : 6);
