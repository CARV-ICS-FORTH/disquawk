...
public abstract class ClassFileMember {
    ...
    /**
     * Determines if this field or method is a static member of its class.
     *
     * @return  true if this is a static class member
     */
    ...
    /**
     * Determines if this field or method is a final member of its class.
     *
     * @return  true if this is a final class member
     */
    ...
    public final boolean hasConstant() {
        return Modifier.hasConstant(modifiers);
    }
